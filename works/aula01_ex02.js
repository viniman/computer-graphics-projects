...
var cylinderGeometry = new THREE.CylinderGeometry(3, 3, 8, 64);
...
// position the cube
cube.position.set(7.0, -7.0, 4.0);
// add the cube to the scene
scene.add(cube);

// position the sphere
sphere.position.set(-5.0, -5.0, 4.0);
// add the cube to the scene
scene.add(sphere);

// position the cylinder
cylinder.position.set(0.0, 5.0, 3.0);
//cylinder.rotation.set(90, 0, 0);
// add the cube to the scene
scene.add(cylinder);
